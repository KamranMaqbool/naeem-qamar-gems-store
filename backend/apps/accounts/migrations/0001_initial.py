    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('CUSTOMER', 'Customer'), ('STAFF', 'Staff'), ('SUPER_ADMIN', 'Super Admin')], default='CUSTOMER', max_length=20)),
                ('is_vip', models.BooleanField(default=False)),
                ('total_lifetime_spend', models.DecimalField(decimal_places=2, default=0, max_digits=12)),
